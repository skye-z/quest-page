<template>
    <n-modal v-model:show="show" preset="card" :style="{ width: '500px' }" :mask-closable="false">
        <template #header>筛选题目</template>
        <n-form ref="form" :model="form">
            <n-form-item label="题干">
                <n-input v-model:value="form.keyword" maxlength="110" type="textarea" placeholder="为保证显示效果, 限110个字符以内" />
            </n-form-item>
