  ...
  <div class="sys-box flex justify-between">
    <div class="sys-item card mr-10 mb-10 full-width">
      ...
      <div class="sys-sub flex justify-between">
        ...
        <div
          class="sys-value"
          :class="{ level2: use.level == 2, level3: use.level == 3 }"
        >
          {{ use.cpu }}%
        </div>
      </div>
    ...
    <div class="sys-item card mr-10 mb-10 full-width">
      ...
      <div class="sys-sub flex justify-between" v-if="use.memory">
        ...
        <div
          class="sys-value"
          :class="{ level2: use.memory.level == 2, level3: use.memory.level == 3 }"
        >
          {{ use.memory.percent }}%
        </div>
      </div>
    ...
    <div class="sys-item card mr-10 mb-10 full-width">
      ...
      <div class="sys-sub flex justify-between" v-if="use.disk">
        ...
        <div
          class="sys-value"
          :class="{ level2: use.disk.level == 2, level3: use.disk.level == 3 }"
        >
          {{ use.disk.percent }}%
        </div>
      </div>
    ...
    <div class="sys-item card mb-10 full-width">
      ...
      <div>
        ...
        <div class="line1">系统版本: {{ system.version }}</div>
...
export default {
  ...
  methods: {
    ...
    distance(timestamp) {
      if (timestamp === undefined || timestamp == null) return "无数据";
